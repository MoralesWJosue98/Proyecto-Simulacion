...
void read_input_file(Mesh *G, char *filename) {
    ...
    float Ad, An, initial_S, delta_t, t_0, t_f, x, y;
    ...
    if (datFile.is_open()) {
        ...
        /*
            ...
            - El valor a aplicar en las condiciones de Dirichlet (Ad).
            - El valor a aplicar en las condiciones de Neumann (An).
            - La autoestima inicial del pokemon (initial_S).
        ...
        */
        ...
        datFile >> Ad >> An >> initial_S >> delta_t >> t_0 >> t_f >> nnodes >> nelems
                >> ndirichlet >> nneumann;
        //Se colocan los parámetros en el objeto Mesh
        G->set_parameters(Ad, An, initial_S, delta_t, t_0, t_f);
...
/*
    ...
    una de ellas contiene los resultados de la autoestima en los nodos de la
